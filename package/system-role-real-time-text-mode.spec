#
# spec file for package system-role-real-time-text-mode
#
...
#   https://github.com/yast/system-role-real-time-text-mode repository
#
...
Provides:       installer_module_extension() = system-role-real-time-text-mode

%description
Meta package for Real Time in Text Mode role definition.
